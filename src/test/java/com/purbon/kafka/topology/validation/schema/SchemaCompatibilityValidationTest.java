...
public class SchemaCompatibilityValidationTest {
  ...
  @Mock private SchemaRegistryManager mockedSchemaRegistry;

  @Test(expected = ValidationException.class)
  public void testSchemaValidationFailIfBothNullTopicAndSchema() throws ValidationException {
    // Given
  ...
  @Test(expected = ValidationException.class)
  public void testSchemaValidationFailIfNullTopic() throws ValidationException {
    // Given
    var instance = new SchemaCompatibilityValidation();
  ...
  @Test(expected = ValidationException.class)
  public void testSchemaValidationFailIfNullSchema() throws ValidationException {
    // Given
    var instance = new SchemaCompatibilityValidation();
  ...
  public void validationFailureMessageForKeySubjectIsCorrect() {
    ...
    var instance = new SchemaCompatibilityValidation();
    var expectedMessage =
        "Schema with keySubject null.default-key and topic: default failed compatibility "
            + "check";
    ...
    try {
      instance.valid(
          mockedSchemaRegistry, new TopicImpl(), new TopicSchemas("testKey", "testValue"));
  ...
  public void validationFailureMessageForValueSubjectIsCorrect() {
    ...
    var instance = new SchemaCompatibilityValidation();
    var expectedMessage =
        "Schema with valueSubject null.default-value and topic: default failed compatibility "
            + "check";
    var schema = new TopicSchemas("testKey", "testValue");
    when(mockedSchemaRegistry.validate("null.default-value", "testValue", "AVRO"))
        .thenReturn(false);
